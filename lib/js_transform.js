...
function js_transform(options){
    return function(req,res,next){
        ...
        if (_.isObject(req.file_config)) {
          ...
          options.external = Array.isArray(file_config.external) ? file_config.external : options.external; 
          options.require = Array.isArray(file_config.require) ? file_config.require : options.require; 
          options.ignore = Array.isArray(file_config.ignore) ? file_config.ignore  : options.ignore; 
